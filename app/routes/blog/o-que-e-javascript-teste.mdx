...
Primeiro vamos criar um simples modulo `math.js` com duas funções de matemática
...
Obs.: **Compartilhe** com alguém que se interessaria por esse assunto.

Fonte de inspiração: [post do Kent C Dodds sobre JS Test](https://kentcdodds.com/blog/but-really-what-is-a-javascript-test)
